...
TitleCommet gTitleComments[] =
{
	...
	{ "DB1A6", "DELTA BASE" },
	{ "DB1A7", "DELTA BASE" },
	{ "ES2A0", "EXIT TO THE SURFACE" },
	{ "ES2A1", "EXIT TO THE SURFACE" },
	{ "ES2A2", "EXIT TO THE SURFACE" },
	{ "ES2A3", "EXIT TO THE SURFACE" },
	{ "ES2A4", "EXIT TO THE SURFACE" },
	{ "ES2A5", "EXIT TO THE SURFACE" },
	{ "ES2A6", "EXIT TO THE SURFACE" },
	{ "ES2A7", "EXIT TO THE SURFACE" },
	{ "ES2A8", "EXIT TO THE SURFACE" },
	{ "ES2A9", "EXIT TO THE SURFACE" },
	{ "ES2A10", "EXIT TO THE SURFACE" },
	{ "ES2A11", "EXIT TO THE SURFACE" },
	{ "NS3A0", "NIGHT SHIFT" },
	{ "NS3A1", "NIGHT SHIFT" },
	{ "NS3A2", "NIGHT SHIFT" },
	{ "NS3A3", "NIGHT SHIFT" },
	{ "NS3A4", "NIGHT SHIFT" },
	{ "XEN4A0", "MISCALCULATING" },
	{ "XEN4A1", "MISCALCULATING" },
	{ "XEN4A2", "MISCALCULATING" },
	{ "XEN4A3", "MISCALCULATING" },
	{ "XEN4A4", "MISCALCULATING" },
	{ "XEN4A5", "MISCALCULATING" },
	{ "ENDMOD", "MISCALCULATING" },
};
